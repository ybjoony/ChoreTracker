...
class ChildrenControllerTest < ActionController::TestCase
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post :create, child: { active: @child.active, first_name: @child.first_name, last_name: @child.last_name }
    end
  ...
  test "should update child" do
    put :update, id: @child, child: { active: @child.active, first_name: @child.first_name, last_name: @child.last_name }
    assert_redirected_to child_path(assigns(:child))
  end
